...
public:
	...
	Relation getEquivalenceClosure() const;					// Get the relational matrix of its equivalence closure
	//====================================================================================================
	...
	//====================================================================================================
	int* getEquivalenceClasses() const;						/* If this relation is an equivalence relation, then stores the number of the equivalent class
	...
	//====================================================================================================
	int* topologicallySorting() const;					// Topology sorting
};
